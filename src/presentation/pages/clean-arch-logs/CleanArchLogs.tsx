...
import type { LogEntry } from '../../../domain/logging/entities/LogEntry';
import { LogEntryItem } from '../../components/logging/LogEntryItem';

interface CleanArchLogsPageProps {
  logs: LogEntry[];
}

export const CleanArchLogsPage = ({ logs }: CleanArchLogsPageProps) => (
  <div className="bg-slate-950 p-6 rounded-2xl border border-slate-800 flex flex-col h-[500px]">
    ...
    <p className="text-xs text-slate-400 leading-relaxed mb-4">
      Cada ação executada no aplicativo atravessa as camadas de software isoladamente. Os logs abaixo
      registram as interações entre as camadas **Presentation**, **Domain**, **Data** e **Infrastructure**.
    </p>
